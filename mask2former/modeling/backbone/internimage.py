...
from mask2former.modeling.backbone.ops_dcnv3 import modules as opsm
import torch.nn.functional as F

from detectron2.modeling import BACKBONE_REGISTRY, Backbone, ShapeSpec

__all__ = ["internimageH", "internimageXL", "internimageL"]
    ...
    def forward(self, x):
        ...
        for level_idx, level in enumerate(self.levels):
            ...
            if level_idx in self.out_indices:
                seq_out[f"res{level_idx + 2}"] = x_.permute(0, 3, 1, 2).contiguous()
        return seq_out
...
class D2internimage(InternImage, Backbone):
    def __init__(self, cfg, input_shape):
        arg_dict = dict(
            ...
            drop_rate=cfg.MODEL.INTERNIMAGE.DROP_RATE, # dropout rate
